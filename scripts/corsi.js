function load_corsi(){
    fetch("corsi_load.php").then(OnResponseCorsi).then(OnJsonCorsi);
}
...
function metti_like(event){
    ...
    fetch("put_like.php?nome=" + encodeURIComponent(nome));
    like.src="images/like_yes.svg";
    load_corsi();
}
...
function togli_like(event){
    ...
    const box=like.parentNode.parentNode.parentNode;
    const nome=box.querySelector('span.nome').textContent;
    fetch("togli_like.php?nome=" + encodeURIComponent(nome));
    like.src="images/like_no.svg";
    load_corsi();
}
...
function aggiungi_scheda(event){
    ...
    const nome=box.querySelector('span.nome').textContent;
    fetch("aggiungi_scheda.php?nome=" + encodeURIComponent(nome));
...
function togli_scheda(event){
    ...
    const box=add.parentNode.parentNode;
    const nome=box.querySelector('span.nome').textContent;
    fetch("togli_scheda.php?nome=" + encodeURIComponent(nome));
